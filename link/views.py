...
def stats(request, id):
    ...
    link_url = request.build_absolute_uri("/link/"+link_db.get_short_id()) # make it an absolute one

    return render_to_response("link-stats.html", {"stats":stats, "link":link_db, "link_url":link_url},
                                        context_instance=RequestContext(request))
