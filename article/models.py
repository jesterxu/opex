...
class mCategories(models.Model):
   ...
   title    	    = models.CharField(max_length=255, verbose_name="Title", help_text = "Category Title")
   chef_title	    = models.CharField(max_length=255, verbose_name="Title Chef", help_text = "Title Chef", blank=True) 
   slug      	    = models.SlugField(max_length=255, verbose_name="Slug")
   
   description      = models.CharField(max_length=500, verbose_name="Descriptions", help_text = "Category Descriptions")
   ...
   def save(self, *args, **kwargs):
       ...
       super(mCategories, self).save(*args, **kwargs)
	   
       self.description_chef = unidecode(self.description)
       super(mCategories, self).save(*args, **kwargs) 	 	   

class Articles(models.Model):
   title    	    = models.CharField(max_length=255, verbose_name="Title", help_text = "Article Title")
   chef_title	    = models.CharField(max_length=255, verbose_name="Title Chef", help_text = "Title Chef", blank=True) 
   slug      	    = models.SlugField(max_length=255, verbose_name="Slug")
   
   description    	    = models.CharField(max_length=500, verbose_name="Description", help_text = "Article Description")
   description_chef	    = models.CharField(max_length=500, verbose_name="Description Chef", help_text = "Description Chef", blank=True)
   
   category			= models.ForeignKey("mCategories", verbose_name="Category")
   
   content_home  = models.TextField(verbose_name="Home Content", help_text = "Home Content will appear")
   content       	= models.TextField(verbose_name="All Content", help_text = "All Content")
   
   home_hard	= models.BooleanField(verbose_name="Home", default=True, help_text = "Does the home text wil appear?")
   ...
   def get_absolute_url(self):
	   return "/article/%s/%s/" %(self.category.slug, self.slug)
