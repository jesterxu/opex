...
class Pages(models.Model):
   ...
   title    	    = models.CharField(max_length=255, verbose_name="Title", help_text = "Page Title")
   chef_title	    = models.CharField(max_length=255, verbose_name="Title Chef", help_text = "Title Chef", blank=True) 
   slug      	    = models.SlugField(max_length=255, verbose_name="Slug")
   
   description    	    = models.CharField(max_length=500, verbose_name="Description", help_text = "Title Description")
   description_chef	    = models.CharField(max_length=500, verbose_name="Description Chef", help_text = "Description Chef", blank=True)
   
   picture   			= models.CharField(max_length=255, verbose_name="Picture", help_text = "Picture", choices=CATEGORY_PICTURES) 
