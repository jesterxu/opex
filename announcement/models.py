...
class Announcements(models.Model):
   ...
   title    	    = models.CharField(max_length=255, verbose_name="Title", help_text = "Announcement Title")
   chef_title	    = models.CharField(max_length=255, verbose_name="Title Chef", help_text = "Title Chef", blank=True) 
   slug      	    = models.SlugField(max_length=255, verbose_name="Slug")
   
   description    	    = models.CharField(max_length=500, verbose_name="Description", help_text = "Announcement Description")
   ...
   picture  		    = models.CharField(max_length=255, verbose_name="Picture", help_text = "Picture", choices=PICTURES) 
   ...
   def get_absolute_url(self):
	   return "/announcement/%s/" %self.slug
